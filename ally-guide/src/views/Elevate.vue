<template>
  <div>
    <div>
      <div>
        <h4>
          Changes start by doing. amplify by contacting congress, signing
          petitions, or contacting your local reps from the dropdown
        </h4>
      </div>
    </div>
    ...
    <div id="search-ui">
      <div>
        ...
        <select for="government-branch">
          <option
            ...
            v-for="level in branchOfGovernment"
            :key="level.branch"
            :value="level.branch"
            >{{ level.branch }}</option
          >
      ...
      <div id="government-contact-info" v-show="hasContent">
        <div
          v-for="member in filteredCongressMembers"
          :key="member.name"
    ...
    <div id="say-their-names">
      ...
      <div
        style="margin: 15px; border: 3px solid; display: inline-block; width: 30%; text-align: center;"
      >
        <h5>Campaigns</h5>
      </div>
      <div
  ...
  created() {
    ...
    this.congressMembers = [
      ...
      },
      {
        ...
        state: "Arizona",
        email: "engage@az.gov",
        contactPage: "https://azgovernor.gov/engage/form/contact-governor-ducey"
      },
      {
      ...
      },
      {
        ...
        contactPage: "https://governor.arkansas.gov/online-services/contact-us/"
      },
      {
        name: "Jared Polis",
        title: "Governor",
      ...
      },
      {
        ...
        contactPage: "https://gov.georgia.gov/contact-us/constituent-services"
      },
      {
        name: "David Ige",
        title: "Governor",
      ...
      },
      {
        ...
        state: "New Mexico",
        email: "",
        contactPage: "https://www.governor.state.nm.us/contact-the-governor/"
      },
      {
        name: "Andrew M Cuomo",
        title: "Governor",
        ...
        state: "New York",
        email: "",
        contactPage: "https://www.governor.ny.gov/content/governor-contact-form"
      },
      {
        name: "Roy Cooper",
        title: "Governor",
        ...
        email: "",
        contactPage: "https://governor.nc.gov/contact/contact-governor-cooper"
      },
      {
        name: "Doug Burgmum",
        title: "Governor",
